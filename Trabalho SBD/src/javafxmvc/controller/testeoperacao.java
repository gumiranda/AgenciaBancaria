...
public class testeoperacao implements Initializable {
    ...
    public boolean showFXMLAnchorPaneCadastrosOperacaoBancariasDialog(OperacaoBancaria operacaoBancaria) throws IOException {
        ...
        loader.setLocation(FXMLAnchorPaneCadastrosOperacaoBancariaDialog.class.getResource("/javafxmvc/view/FXMLAnchorPaneCadastrosOperacaoBancariaDialog.fxml"));
        ...
        FXMLAnchorPaneCadastrosOperacaoBancariaDialog controller = loader.getController();
